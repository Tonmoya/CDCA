...
#correlation matrix
# SZ
data_D1_gse165604 <- read.csv(file = "corr_D1_gse165604.csv", stringsAsFactors = FALSE)
...
data_C1_gse165604 <- read.csv(file = "corr_C1_gse165604.csv", stringsAsFactors = FALSE)
...
data_D1_gse138082 <- read.csv(file = "corr_D1_gse138082.csv", stringsAsFactors = FALSE)
...
data_C1_gse138082 <- read.csv(file = "corr_C1_gse138082.csv", stringsAsFactors = FALSE)
...
# BD
data_D1_gse53239 <- read.csv(file = "corr_D1_gse53239.csv", stringsAsFactors = FALSE)
...
data_C1_gse53239 <- read.csv(file = "corr_C1_gse53239.csv", stringsAsFactors = FALSE)
...
data_D1_gse80336 <- read.csv(file = "corr_D1_gse80336.csv", stringsAsFactors = FALSE)
...
data_C1_gse80336 <- read.csv(file = "corr_C1_gse80336.csv", stringsAsFactors = FALSE)
